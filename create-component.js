...
const showHelp = () => {
  ...
  console.log(
    'node create-component --name <cmp-name> [--dir <name>] [--cmp-type <class|func>] [--style <type>]'
  )
  console.log('')
...
try {
  ...
  const template =
    cmpType === 'class' ? componentClassTemplate : componentFunctionTemplate
  fs.writeFileSync(`${rootDir}/${name}.tsx`, template(name, style))
